...
\put(0.25,0.04){\includegraphics[width=0.24\columnwidth]{imgs/trap_bottomleft_start.png}}
\put(0.25,0.29){\includegraphics[width=0.24\columnwidth]{imgs/trap_topright_start.png}}
...
\put(0.08,0.56){\includegraphics[width=0.23\columnwidth]{imgs/hanger_firstperson_close_train.png}}
\put(0.08,0.08){\includegraphics[width=0.23\columnwidth]{imgs/hanger_firstperson_close.png}}

\put(0.56,0.56){\includegraphics[width=0.23\columnwidth]{imgs/trap_topright_end.png}}
\put(0.56,0.08){\includegraphics[width=0.23\columnwidth]{trial_imgs/trapezoid_firstperson.png}}

\put(1.04,0.56){\includegraphics[width=0.23\columnwidth]{imgs/hammer_firstperson_grasp1_train_crop.png}}
\put(1.04,0.08){\includegraphics[width=0.23\columnwidth]{imgs/hammer_firstperson_grasp1_crop.png}}

\put(1.52,0.56){\includegraphics[width=0.23\columnwidth]{imgs/bottle_firstperson_train_crop.png}}
\put(1.52,0.08){\includegraphics[width=0.23\columnwidth]{imgs/bottle_firstperson_test_crop.png}}
